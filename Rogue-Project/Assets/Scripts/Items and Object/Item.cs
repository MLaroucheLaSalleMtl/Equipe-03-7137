...
//            {
//                Potion potionTemp = new Potion($"{potionType.ToString()}", NewStats(levelMC.level), GetSpriteByName(potionType.ToString(), id), (PotionType)randomPotionType, false, id);
...
//            if (randomWeapType == 0)
//            {
//                MeleeWeapon weaponTemp = new MeleeWeapon($"{weaponName.ToString()}", NewStats(levelMC.level), GetSpriteByName(weaponName.ToString(), id), (WeaponType)randomWeapType, (MeleeClass)randomWeapClass, false, id);
...
//            {
//                DistanceWeapon weaponTemp = new DistanceWeapon($"{weaponName.ToString()}", NewStats(levelMC.level), GetSpriteByName(weaponName.ToString(), id), (WeaponType)randomWeapType, (DistanceClass)randomWeapClass, false, id);
//                items.Add(weaponTemp);
...
//        {
//            Armor armorTemp = new Armor($"{armorName.ToString()} {armorTypeName.ToString()}", NewStats(levelMC.level), GetSpriteByName(armorName.ToString(), id), (ArmorType)randomArmorType, (ArmorClass)randomArmorClass, false, id);
//            items.Add(armorTemp);
...
//    static void LoadDictionary(int id)
//    {
...
//        {
//            sprites.Add(SpritesData[i].name + id, SpritesData[i]);
//        }
//    }

//    public static Sprite GetSpriteByName(string name, int id)
//    {
//        LoadDictionary(id);
