...
public class EnemyStateMachine : MonoBehaviour
{
    ...
    void Update()
    {
        switch (Battle_State)
        {
            ...
            case (StateOfBattle.TAKE_ACTION):
                chooseAction();
    ...
    void TurnTimer()
    {
        ...
        {
            Battle_State = StateOfBattle.TAKE_ACTION;
        }
    }
    ...
    void chooseAction()
    {
        ...
        thisAttack.attackersName = EBC.name;;
        thisAttack.AttackerGameObject = this.gameObject;
        thisAttack.AttackersTarget = BSM.MainCharacter[Random.Range(0, BSM.MainCharacter.Count)];
